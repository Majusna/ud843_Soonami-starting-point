...
public class MainActivity extends AppCompatActivity {
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            /* 1. "ulazni tok" informacija - citljiv izvor bajtova*/
            InputStream inputStream = null;
            try {/*postavljanje zahteva - do urlConnection.connect(); */
                urlConnection = (HttpURLConnection) url.openConnection();
                urlConnection.setRequestMethod("GET");
                urlConnection.setReadTimeout(10000 /* milliseconds */);
                urlConnection.setConnectTimeout(15000 /* milliseconds */);

                urlConnection.connect();     /*uspostavljanje http veze  */

     /*sve posle uspostavljanja veze je primanje odgovora i pravljenje smisla za aplikaciju */
                if (urlConnection.getResponseCode()== 200 ){ /*.getResponseCode() metod koji vraca status :200, 404, 500... */
        ...
        private String readFromStream(InputStream inputStream) throws IOException {
            ...
            if (inputStream != null) {
                /*cita podatke inputStream-a i prebacuje ih u zeljeni oblik (umota inputStream)
                * Charset - character set - precizira kako da preede infor.u citljive bajt po bajt */
                InputStreamReader inputStreamReader = new InputStreamReader(inputStream, Charset.forName("UTF-8"));
                /* 2. buffer - amortizer, citac - sastavlj bajtobe u nesto znacajno sto app moze da koristi
                * dopuna inputStreaReaderu, posto moze biti spor (umota inputStreamReader)  */
                BufferedReader reader = new BufferedReader(inputStreamReader);
                /* 3. JSON response string - niz kojji je tok karaktera */
